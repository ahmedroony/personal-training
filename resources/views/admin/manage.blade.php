                                    ...
                                    <td>
                                        @if ($user->subscription?->description)
                                            <details style="cursor: pointer; position: relative;">
                                                ...
                                                <div
                                                    style="background: #1a1a1a; padding: 10px; border-radius: 5px; margin-top: 5px; font-size: 13px; color: #ccc; border: 1px solid #333; position: absolute; z-index: 100; max-width: 250px; right: 0;">
