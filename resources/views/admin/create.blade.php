            ...
            <div class="form-container">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" placeholder="مثال: أحمد محمد علي">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="package" class="form-input" placeholder="مثال: باقة شهرية">
                    </div>

                    <div class="form-group">
                        <label class="form-label">رقم الهاتف</label>
                        <input type="tel" class="form-input" placeholder="01xxxxxxxxx">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-input" placeholder="مثال: 30">
                    </div>
